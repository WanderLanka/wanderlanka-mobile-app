...
export default function BookingConfirmationScreen() {
  ...
  const confettiAnim = new Animated.Value(1);
  ...
  const saveToUpcomingBookings = async (booking: ConfirmedBooking) => {
    try {
      ...
      await AsyncStorage.setItem('upcomingBookings', JSON.stringify(bookingsArray));
    } catch (error) {
              ...
              <View style={styles.serviceRow}>
                <View style={styles.serviceInfo}>
                  ...
                  <ThemedText style={styles.serviceName}>
                    Accommodation ({confirmedBooking.accommodation.length})
                  </ThemedText>
                </View>
                <ThemedText style={styles.servicePrice}>
                  ${confirmedBooking.accommodation.reduce((sum, item) => sum + (item.totalPrice || 0), 0)}
                </ThemedText>
              </View>
            )}
            ...
            {confirmedBooking.transport.length > 0 && (
              <View style={styles.serviceRow}>
                <View style={styles.serviceInfo}>
                  ...
                  <ThemedText style={styles.serviceName}>
                    Transport ({confirmedBooking.transport.length})
                  </ThemedText>
                </View>
                <ThemedText style={styles.servicePrice}>
                  ${confirmedBooking.transport.reduce((sum, item) => sum + (item.totalPrice || 0), 0)}
                </ThemedText>
              </View>
            )}
            ...
            {confirmedBooking.guides.length > 0 && (
              <View style={styles.serviceRow}>
                <View style={styles.serviceInfo}>
                  ...
                  <ThemedText style={styles.serviceName}>
                    Tour Guides ({confirmedBooking.guides.length})
                  </ThemedText>
                </View>
                <ThemedText style={styles.servicePrice}>
                  ${confirmedBooking.guides.reduce((sum, item) => sum + (item.totalPrice || 0), 0)}
                </ThemedText>
              </View>
            )}
          </View>
